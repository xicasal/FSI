...
class PriorityQueue(Queue):
    ...
    def __init__(self, default_max, property_name):
        self.A = []
        self.defaultMax = default_max
        self.start = 0
    ...
    def pop(self):  # ExtractMin  O(n)
        ...
        for n in self.A:
            if n.__dict__[self.property_name] < minimal.__dict__[self.property_name]:
                minimal = n
...
class PriorityQueueHeuristic(Queue):
    ...
    def __init__(self, default_max, property_name, problem):
        self.A = []
        self.defaultMax = default_max
        self.start = 0
        self.property_name = property_name
